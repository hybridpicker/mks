    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chord_name', positionfinder.notes_choices.ChordChoicesField(choices=[('Augmented', 'Augmented'), ('Diminished', 'Diminished'), ('Dominant 7', 'Dominant 7'), ('Major', 'Major'), ('Major 7', 'Major 7'), ('Minor', 'Minor'), ('Minor 7', 'Minor 7'), ('Minor7b5', 'Minor 7b5')], default='Major 7', max_length=20, verbose_name='Chord Name')),
